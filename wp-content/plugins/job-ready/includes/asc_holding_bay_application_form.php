...
// Accredited Short Course Holding Bay Application Form (ASC)
...
function asc_holding_bay_form_accredited_submission_process($entry, $form_data) 
{
	...
	if(ASC_HOLDING_BAY_DEBUG_MODE)
	{
		echo '<a href="' . JR_ROOT_URL . '/pdf/' . $ahbfp. '" target="_blank">Short Course Accredited - Holding Bay Applcation Form (PDF)</a><br/><br/>';
	}
...
function neca_pdf_content_office_use_only_asc_holding_bay( $form, $show_dates = true ) 
{
	...
	$content .= '<table class="tbl">
					<tr>
						<td colspan="2" class="small"><strong>PROGRAM DETAILS (Accredited Short Course)</strong></td>
					</tr>
					<tr>
						<tr>
