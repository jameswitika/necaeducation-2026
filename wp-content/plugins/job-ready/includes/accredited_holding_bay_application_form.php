...
// Accredited Holding Bay Application Form (ASC)
add_filter("gform_pre_render_" . ASC_HOLDING_BAY_APPLICATION_FORM, 'asc_holding_bay_application_form_prepopulate');
add_filter("gform_pre_validation_" . ASC_HOLDING_BAY_APPLICATION_FORM, 'asc_holding_bay_application_form_prepopulate');
add_filter("gform_pre_submission_filter_" . ASC_HOLDING_BAY_APPLICATION_FORM, 'asc_holding_bay_application_form_prepopulate');
add_filter("gform_admin_pre_render" . ASC_HOLDING_BAY_APPLICATION_FORM, 'asc_holding_bay_application_form_prepopulate');

function asc_holding_bay_application_form_prepopulate($form)
{
	$prefill_fields= array();
	
	if(ASC_HOLDING_BAY_DEBUG_MODE)
	{
		echo "Prefill: <br/>";
 ...
 * *************** */
// Accredited Holding Bay Application Form (ASC)
add_filter("gform_pre_submission_" . ASC_HOLDING_BAY_APPLICATION_FORM, 'asc_holding_bay_application_form_presubmission');

function asc_holding_bay_application_form_presubmission()
{
	if(isset($_SESSION['prefill']))
	{
...
add_action('gform_after_submission_' . ASC_HOLDING_BAY_APPLICATION_FORM, 'asc_holding_bay_form_accredited_submission_process', 10, 2);

function asc_holding_bay_form_accredited_submission_process($entry, $form_data) 
{
	if (ASC_HOLDING_BAY_DEBUG_MODE) 
	{
		echo "<h3>ASC Holding Bay Application Form - Submission Process</h3>";
	}
	...
	$form->street_number = ucwords ( strtolower ( rgar($entry, '138')) );
	$form->street_name = ucwords ( strtolower ( rgar($entry, '139')) );
	...
	if ($form->postal_address_same != 'Yes') 
	{
		...
		$form->postal_street_number = ucwords ( strtolower ( rgar($entry, '140')) );
		$form->postal_street_name = ucwords ( strtolower ( rgar($entry, '141')) );
	...
	// Create PDF
	$ahbfp = asc_holding_bay_application_form_pdf( $form );
	if(ASC_HOLDING_BAY_DEBUG_MODE)
	{
		echo '<a href="' . JR_ROOT_URL . '/pdf/' . $ahbfp. '" target="_blank">Accredited Holding Bay - Applcation Form (PDF)</a><br/><br/>';
	}
	...
	*/
	...
	if (isset ( $party_id )) 
	{
		...
		$pdf_file = JR_ROOT_PATH . '/pdf/' . $ahbfp;
		...
		$document->description = 'Accredited Application Form (' . $form->course_scope_code . ' - ' . $form->course_number . ')';
...
// Setup ASC Holding Bay Application Form PDF
function asc_holding_bay_application_form_pdf($form) 
{
	// Start
	$content = neca_pdf_content_start ();
	
	// Add Heading
	$content .= neca_pdf_content_heading ( 'Accredited - Application Form', $form );
	...
	// Signatures
	$content .= neca_pdf_content_signatures_asc_holding_bay ( $form );
	...
	// Office Use Only
	$content .= neca_pdf_content_office_use_only_asc_holding_bay( $form );
...
// Signatures (ASC)
function neca_pdf_content_signatures_asc_holding_bay( $form, $tick_all = false ) 
{
...
// Office Only Use (ASC)
function neca_pdf_content_office_use_only_asc_holding_bay( $form, $show_dates = true ) 
{
	...
	$content .= '<table class="tbl">
					<tr>
						<td colspan="2" class="small"><strong>PROGRAM DETAILS (Accredited)</strong></td>
					</tr>
					<tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">Battery Storage</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">Optical Fibre</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">Construction Induction Card</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">CPR + LVR</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">First Aid</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">Grid Connect</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">Open Registration</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">Structured and Coax Cabling</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">Cert IV of Project Management Practice</td>
						</tr>
						<tr>
							<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 95%;" class="small">Diploma of Project Management Practice</td>
						</tr>
					</tr>
				</table>
				<br/>
				<table class="tbl">
					<tr>
						...
						<td style="width: 75%;" class="small">' . $course_name . '</td>
					</tr>';
	...
	if ($show_dates) 
	{
		$content .= '	<tr>
							...
							<td style="width: 75%;" class="small">' . $start_date . '</td>
						</tr>
						<tr>
							<td style="width: 25%;" class="small">End Date: </td>
							<td style="width: 75%;" class="small">' . $end_date . '</td>
						</tr>';
	}
	...
	$content .= '</table>
				...
				<table class="tbl">
					<tr>
						...
						<td style="width: 25%;" class="small">&nbsp;</td>
					</tr>
					<tr>
						<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
					...
					<tr>
						<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
						<td style="width: 45%;" class="small">Full fee service: </td>
						<td style="width: 25%;" class="small">Rates per SCH: </td>
						<td style="width: 25%;" class="small">&nbsp;</td>
					</tr>
					<tr>
						<td style="width: 5%;" class="small">[&nbsp;&nbsp;&nbsp;]</td>
						<td style="width: 45%;" class="small">Resources & Amenities Fee: </td>
						<td style="width: 25%;" class="small">Rates per SCH: </td>
						<td style="width: 25%;" class="small">&nbsp;</td>
					</tr>
				</table>';
