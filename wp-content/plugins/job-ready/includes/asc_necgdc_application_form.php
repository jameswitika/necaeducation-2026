...
add_filter("gform_pre_render_" . SHORT_COURSE_APPLICATION_NECGDC001, 'short_course_accredited_necgdc_application_form_prepopulate');
add_filter("gform_pre_validation_" . SHORT_COURSE_APPLICATION_NECGDC001, 'short_course_accredited_necgdc_application_form_prepopulate');
add_filter("gform_pre_submission_filter_" . SHORT_COURSE_APPLICATION_NECGDC001, 'short_course_accredited_necgdc_application_form_prepopulate');
add_filter("gform_admin_pre_render" . SHORT_COURSE_APPLICATION_NECGDC001, 'short_course_accredited_necgdc_application_form_prepopulate');

function short_course_accredited_necgdc_application_form_prepopulate($form)
{
	$prefill_fields= array();
	
	if(ASC_NECGDC_DEBUG_MODE)
	{
		echo "Prefill: <br/>";
 ...
 * *************** */
// Short Course (Accredited) Application Form (ASC)
add_filter("gform_pre_submission_" . SHORT_COURSE_APPLICATION_NECGDC001, 'short_course_accredited_necgdc_application_form_presubmission');

function short_course_accredited_necgdc_application_form_presubmission()
{
	if(isset($_SESSION['prefill']))
	{
...
add_action('gform_after_submission_' . SHORT_COURSE_APPLICATION_NECGDC001, 'short_course_application_necgdc_form_accredited_submission_process', 10, 2);

function short_course_application_necgdc_form_accredited_submission_process($entry, $form_data)
{
	if (ASC_NECGDC_DEBUG_MODE) 
	{
		echo "<h3>Short Course Application Form - NECGDC002 Submission Process</h3>";
	}
	...
	*/
	...
	if (isset ( $party_id )) 
	{
		...
		else 
		{
			if (ASC_NECGDC_DEBUG_MODE) 
			{
				echo "Error occurred when creating Party Document<br/><br/>";
				echo "Party Document Result: ";
				echo "<pre>";
...
// Setup Short Course (NECGDC002) Application Form PDF
function short_course_accredited_necgdc_application_form_pdf($form) 
{
	// Start
	$content = neca_pdf_content_start ();
	
	// Add Heading
	$content .= neca_pdf_content_heading ( 'NECGDC002 Grid Connect - Application Form', $form );
	...
	// Signatures
	$content .= neca_pdf_content_signatures_necgdc ( $form );
	...
	// Office Use Only
	$content .= neca_pdf_content_office_use_only_necgdc ( $form );
...
// Signatures (ASC)
function neca_pdf_content_signatures_necgdc( $form, $tick_all = false ) 
{
...
// Office Only Use (ASC)
function neca_pdf_content_office_use_only_necgdc( $form, $show_dates = true ) 
{
	...
	$content .= '<table class="tbl">
					<tr>
						<td colspan="4"><strong>PROGRAM DETAILS (Accredited Short Course)</strong></td>
					</tr>
					<tr>
						<tr>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">Battery Storage</td>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">Optical Fibre</td>
						</tr>
						<tr>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">Construction Induction Card</td>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">CPR + LVR</td>
						</tr>
						<tr>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">First Aid</td>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">Grid Connect</td>
						</tr>
						<tr>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">Open Registration</td>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">Structured and Coax Cabling</td>
						</tr>
						<tr>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">Cert IV of Project Management Practice</td>
							<td style="width: 5%;">[&nbsp;&nbsp;&nbsp;]</td>
							<td style="width: 45%;">Diploma of Project Management Practice</td>
						</tr>
					</tr>
				</table>
				<br/>
	...
	if ($show_dates) 
	{
		$content .= '	<tr>
							...
							<td style="width: 40%;">' . $start_date . '</td>
							<td style="width: 10%;">End Date: </td>
							<td style="width: 40%;">' . $end_date . '</td>
						</tr>';
	}
